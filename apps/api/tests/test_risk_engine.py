...
def test_risk_score_is_deterministic_and_evidence_backed():
    ...
    assert first.score==second.score==20
    assert first.band==second.band==RiskBand.GUARDED
